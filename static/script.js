// At the top of your script.js, update the API_URL
const API_URL = window.location.origin;  // This will use the same origin as the page
...
async function sendMessage() {
    ...
    try {
        console.log('Sending request to:', `${API_URL}/ask/stream`);
